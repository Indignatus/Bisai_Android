...
public class TeamDetailActivity extends AppCompatActivity implements TeamCallback {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            listaJugadores = (ListView) findViewById(R.id.listaequipos);
            // al clicar encima de uno de los equipos

            TeamManager.getInstance().getEquipoById(equipoId, TeamDetailActivity.this);
        }
        ...
        public class JugadoresAdapter extends BaseAdapter {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (myView == null) {
                    ...
                    TeamDetailActivity.JugadoresAdapter.ViewHolder holder = new TeamDetailActivity.JugadoresAdapter.ViewHolder();
                ...
                TeamListActivity.TeamsAdapter.ViewHolder holder = (TeamListActivity.TeamsAdapter.ViewHolder) myView.getTag();
