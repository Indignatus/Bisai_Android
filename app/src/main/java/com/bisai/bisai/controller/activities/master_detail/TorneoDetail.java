...
public class TorneoDetail extends AppCompatActivity implements TorneoCallback{
    ...
    public void onSuccessTorneo(Torneo torneo) {
        ...
        Button button = (Button) findViewById(R.id.seleccionEquipoPropio);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(TorneoDetail.this, SeleccionEquipoForJoinTeam.class);
                i.putExtra("torneo", torneoId);
                startActivity(i);
    }
});
